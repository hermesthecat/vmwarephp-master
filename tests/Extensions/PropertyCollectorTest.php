...
class PropertyCollectorTest extends PHPUnit_Framework_TestCase
{
	...
	function setUp()
	{
		...
		$this->propertyCollector = new \Vmwarephp\Extensions\PropertyCollector(
			$this->vmwareService,
			new ManagedObjectReference('propertyCollector', 'PropertyCollector'),
			$this->propertyFilterFactory
		);
	}
